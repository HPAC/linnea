...
MATLABPATH=${HOME}/matrix_generators/MatlabMatrixGenerator matlab -singleCompThread -nodisplay -nodesktop -nosplash -logfile matlab.log <${HOME}/linnea/output/lamp_example0c/Matlab/runner.m
