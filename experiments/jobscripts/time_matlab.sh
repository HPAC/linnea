...
MATLABPATH=${HOME}/matrix_generators/MatrixGeneratorMatlab matlab -singleCompThread -nodisplay -nodesktop -nosplash -logfile matlab.log <<"run ${HOME}/linnea/output/lamp_example1c/Matlab/runner;quit();EOF"
