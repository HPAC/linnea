...
cholesky = FactorizationKernel(
    ...
    [OutputOperand(_L, _A, ("N", "N"), [properties.LOWER_TRIANGULAR], StorageFormat.lower_triangular)],
    cf,
    None,
...
plu = FactorizationKernel(
    ...
    Times(_P, _L, _U),
    [OutputOperand(_L, _A, ("N", "N"), [properties.LOWER_TRIANGULAR, properties.UNIT_DIAGONAL], StorageFormat.LUfact_L),
     OutputOperand(_U, _A, ("N", "N"), [properties.UPPER_TRIANGULAR], StorageFormat.LUfact_U),
