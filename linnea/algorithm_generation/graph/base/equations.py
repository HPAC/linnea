...
class EquationsGraph(base.Graph):
    ...
    def write_output(
        ...
        if experiment_code:
            generate_experiment_code(output_name, self.input, algorithm_name, config.experiment_configuration["threads"], config.experiment_configuration["repetitions"], k_best, len(algorithms))
